...
def About(request):
    tex = {}
    return render(request,'blog/about.html',tex)
...
def Services(request):
    tex = {}
    return render(request,'blog/services.html',tex)

def Partfifolio(request):
    tex = {}
    return render(request,'blog/partifolio.html',tex)


def Pricing(request):
    tex = {}
    return render(request,'blog/pricing.html',tex)



def Question(request):
    tex = {}
    return render(request,'blog/question.html',tex)


def Section(request):
    tex = {}
    return render(request,'blog/section.html',tex)


def Talaba(request):
    tex = {}
    return render(request,'blog/talaba.html',tex)
